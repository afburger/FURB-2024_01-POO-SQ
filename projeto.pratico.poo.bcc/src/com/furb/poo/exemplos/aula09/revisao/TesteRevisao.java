...
public class TesteRevisao {
    public static void main(String[] args) {
        ...
        Gerente gerente = new Gerente("Alice", 8000);
        Desenvolvedor desenvolvedor = new Desenvolvedor("João", 5000);
        ...
        gerente.exibirDetalhes();  // Saída: Nome: Alice, Salário: 8000

        System.out.println("\nDetalhes do Desenvolvedor:");
        desenvolvedor.exibirDetalhes();  // Saída: Nome: João, Salário: 5000
        
        System.out.println("\nDetalhes do Funcionario:");
        funcionario.exibirDetalhes();  // Saída: Nome: João, Salário: 5000
